              ...
              this.userService.assignRoleToUSer(this.user.id, this.selectedRole.id).subscribe(
                {
                  next: (data) => {
                    console.log(data);
                    this.messageService.add({ severity: 'success', summary: 'Successful', detail: 'User Updated', life: 3000, key:'tst' });
                  },
                  error: (e) => alert(e)
                }
              );
        ...
        this.userService.saveUser(this.user).subscribe(
          {
            next: (data) => {
              ...
              this.messageService.add({ severity: 'success', summary: 'Successful', detail: 'User Created', life: 3000, key:'tst'  });
            },
            error: (e) => alert(e)
          }
        );
